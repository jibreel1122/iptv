...
ALTER TABLE IF EXISTS orders ADD COLUMN IF NOT EXISTS offer_title VARCHAR(255);
ALTER TABLE IF EXISTS orders ADD COLUMN IF NOT EXISTS offer_price DECIMAL(10,2);
ALTER TABLE IF EXISTS orders ADD COLUMN IF NOT EXISTS status VARCHAR(50) DEFAULT 'pending';
